...
.then (data => {
    const revistaTitulo = document.getElementById ('articulos-container');
...
modalContenido.style.display = 'none'; // oculta la imagen inicialmente
...
const closeBtn = document.getElementByIdClassName ('close') [0];
